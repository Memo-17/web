    ...
    .row{
        ...
        <main class="main">
            <section>
                ...
                <div class="row">
                <div class="col-sm-6">
                    <form action="index.php?c=comentarios&a=buscar" method="POST">
                        <input type="text" name="busqueda" id="busqueda" placeholder="buscar..."/>
                        <button type="submit" class="btn btn btn-dark"><i class="fas fa-search"></i>Buscar</button>
                        <a href="index.php?c=comentarios&a=presentar">
                    ...
                    ?>
                        <tr>
                            ...
                            <a class="btn btn-primary"
                                        href="index.php?c=comentarios&a=editar&id=<?php echo $fila['ID_USUARIO']; ?>"><i
                                        class="fas fa-marker"></i></a>
                                    <a class="btn btn-danger"
                                        onclick="if(!confirm('Esta seguro de eliminar este mensaje?'))return false;"
                                        href="index.php?c=comentarios&a=eliminar&id=<?php echo $fila['ID_USUARIO']; ?>"><i
